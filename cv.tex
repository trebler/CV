...
\cventry{01/2019\ldots{}}{Full Stack Developer}{eDrilling AS}{Stavanger, Norway}{}{Architecture and development of software for oil and gas industry with cloud deployment\newline{}%
\begin{itemize}%
\item Backend: \texttt{TypeScript/Node.js}, \texttt{Go}, \texttt{C++17/Qt}
...
\section{Programming and Simulation Software Tools}
...
\cvitemwithcomment{}{\emph{Misc}}{\emph{Redis}, \emph{RabbitMQ}, \emph{OpenAPI/Swagger}, \emph{NGINX/Traefik/HAproxy}, \emph{OAuth 2.0}, \emph{WebGL}}
