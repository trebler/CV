\documentclass[11pt,a4paper,a4paper]{moderncv}
...
\cvitem{Citizenship}{\emph{Norwegian}}
\cvitem{Marital status}{\emph{Married}}
...
\cventry{01/2019\ldots{}}{Full Stack Developer}{eDrilling AS}{Stavanger, Norway}{}{Architecture and development of microservices, RESTFul APIs, web applications for oil and gas industry with cloud deployment\newline{}%
\begin{itemize}%
\item Backend: \texttt{TypeScript/Node.js (ES2020)}, \texttt{Go}, \texttt{C++17/Qt}
%\item Desktop: \texttt{C++17/Qt}
\item Frontend: \texttt{TypeScript/Vue.js}, \texttt{TypeScript/React}
\item DevOps: \texttt{Docker}, \texttt{Kubernetes}, \texttt{Azure}, \texttt{AWS}
\item Technologies: \texttt{OpenAPI}, \texttt{Redis}, \texttt{RabbitMQ}, \texttt{WebSockets}, \texttt{Traefik}, \texttt{Keycloak}, \texttt{OAuth 2.0}
\end{itemize}}
...
\cvitemwithcomment{}{GNU/Linux, MacOS, Windows}{}
\cvitemwithcomment{}{\emph{Programming}}{\emph{TypeScript/JavaScript (ES2020)}, \emph{Node.js/Deno}, 
\emph{Go}, \emph{C99}, \emph{C++17}, \emph{Bash}, \emph{HTML/CSS/SASS}}
%, \emph{QML}, \emph{Fortran}, \emph{CUDA/OpenCL}, \emph{Simatic~Step~7}, \emph{Assembler}}
\cvitemwithcomment{}{\emph{Frameworks}}{\emph{Qt}, \emph{Vue.js}, \emph{Angular}, \emph{React}, \emph{three.js},  \emph{D3.js}, \emph{express.js}, \emph{Bulma/Bootstrap}}
\cvitemwithcomment{}{\emph{DevOps}}{\emph{Docker}, \emph{Kubernetes}, \emph{AWS}, \emph{Azure}}
%\cvitemwithcomment{}{\emph{IDEs}}{\emph{Visual Studio Code}, \emph{Qt Creator}, \emph{Xcode}, \emph{Visual Studio}, \emph{Simatic Manager}}
\cvitemwithcomment{}{\emph{Bug tracking systems}}{\emph{Jira}, \emph{Bitbucket}, \emph{TFS}, \emph{Redmine}}
%\cvitemwithcomment{}{\emph{Revision control systems}}{\emph{Git}, \emph{SVN}}
\cvitemwithcomment{}{\emph{Technologies}}{\emph{Redis}, \emph{RabbitMQ}, \emph{OpenAPI/Swagger}, \emph{NGINX/Traefik/HAproxy}, \emph{WebSockets}, \emph{OAuth 2.0}, \emph{Keycloak}, \emph{WebGL}}
...
\cvitem{[2]}{\textbf{A. Trebler}, A. Stohl, and P. Seibert, ``Identification of Greenhouse Gas Emission Sources Using Analytical Inverse Method,'' in \emph{Algorithmic Analysis of Unstable Problems: Abstracts of the International Conference Dedicated to the Memory of V. K. Ivanov}, Institute of Mathematics and Mechanics, Ural Branch of the Russian Academy of Sciences, Ekaterinburg, Russia, 2011, \url{http://aanz.imm.uran.ru/aanz/AANZ-2011-final.pdf}.}
...
\cvitem{[3]}{\textbf{Andrey Trebler}, On Cascades of Bifurcations Leading to Chaos in Several Nonlinear Dissipative Systems of ODEs, \emph{Communications in Nonlinear Science and Numerical Simulation}, vol.~15, no.~10, pp.~2974--2986, 2010, \href{http://dx.doi.org/10.1016/j.cnsns.2009.11.019}{doi: 10.1016/j.cnsns.2009.11.019}.}
\cvitem{[4]}{\textbf{Andrey Trebler}, A Transition to Chaos in Rucklidge Model of Double Convection, in \emph{CIMCA '08: Proceedings of the 2008 International Conference on Computational Intelligence for Modelling Control \& Automation}, 2008, IEEE Computer Society, pp.~952--957, \href{http://dx.doi.org/10.1109/CIMCA.2008.46}{doi: 10.1109/CIMCA.2008.46}.}
