...
\cvitem{}{Experienced *nix-oriented software engineer with passion for backend, system design, and design of APIs; interest in development of rich reactive web applications; and fun of using advanced features of Kubernetes for modern containerized deployment}

\section{Work Experience}
\cventry{12/2023--\ldots}{Lead Software Engineer}{W3Schools Network}{Sandnes, Norway}{}{%
\begin{itemize}%
\item Backend/Frontend: \texttt{node.js (20) / Next.js, TypeScript (ES2023)}
\item DevOps: \texttt{AWS Lambda}, \texttt{AWS CDK/AWS CloudFormation}, \texttt{AWS CodePipeline}
\item Technologies: \texttt{Amazon DynamoDB}, \texttt{Amazon SQS}, \texttt{Amazon S3}, \texttt{OpenAI API}
\end{itemize}}
\cventry{01/2019--12/2023}{Senior Software Engineer / Tech Lead}{eDrilling}{Stavanger, Norway}{}{Team lead and software architect responsible for transition to cloud and design of modern APIs. Development and deployment of highly available and scalable Kubernetes-native systems based on microservices architecture, event-driven architecture. Design and implementation of public HTTP REST(ful), SSE and WebSocket APIs. Development of reactive web applications\newline{}%
\begin{itemize}%
\item Backend: \texttt{Go}, \texttt{TypeScript/node.js (ES2023)}, \texttt{C++20}, \texttt{Python}, \texttt{Qt}
%\item Desktop: \texttt{C++17/Qt}
\item Frontend: \texttt{TypeScript/Vue.js (2/3)}, \texttt{TypeScript/React}
\item DevOps: \texttt{Docker}, \texttt{Kubernetes}, \texttt{Kustomize}, \texttt{Azure}, \texttt{AWS}, \texttt{GitHub Actions}, \texttt{GitLab CI/CD}
\item Technologies: \texttt{RabbitMQ (AMQP / Streams)}, \texttt{MongoDB}, \texttt{Redis}, \texttt{WebSockets}, \texttt{OpenAPI 3.0}, \texttt{Server-Sent Events}, \texttt{Traefik}, \texttt{Kubernetes API}, \texttt{OAuth 2.0}, \texttt{Keycloak}, \texttt{Azure AD}
\end{itemize}}
...
\cvitemwithcomment{}{\emph{Programming}}{\emph{TypeScript/JavaScript (ES2023)}, \emph{node.js (20)}, \emph{Deno},
\emph{Go}, \emph{C++20/23}, \emph{Python}, \emph{C99}, \emph{Bash}, \emph{HTML/CSS/SASS}}
%, \emph{QML}, \emph{Fortran}, \emph{CUDA/OpenCL}, \emph{Simatic~Step~7}, \emph{Assembler}}
\cvitemwithcomment{}{\emph{Frameworks}}{\emph{Qt}, \emph{Vue.js}, \emph{Angular}, \emph{React}, \emph{Next.js}, \emph{three.js},  \emph{D3.js}, \emph{express.js}, \emph{Bulma/Bootstrap}, \emph{FastAPI}, \emph{Echo}}
\cvitemwithcomment{}{\emph{DevOps}}{\emph{Docker}, \emph{Kubernetes}, \emph{AWS Lambda}, \emph{AWS CDK/CloudFormation}, \emph{Azure}, \emph{DigitalOcean}, \emph{GitHub Actions}, \emph{GitLab CI/CD}, \emph{AWS CodePipeline}, \emph{Ansible}, \emph{Kustomize}, \emph{Helm}}
...
\cvitemwithcomment{}{\emph{Technologies}}{\emph{Redis}, \emph{MongoDB}, \emph{DynamoDB}, \emph{RabbitMQ}, \emph{WebSockets}, \emph{AMQP}, \emph{MQTT}, \emph{SSE}, \emph{OpenAPI/Swagger}, \emph{GraphQL}, \emph{Traefik/NGINX/HAproxy}, \emph{S3}, \emph{OpenAI}, \emph{OAuth 2.0}, \emph{Keycloak}, \emph{WebGL}, \emph{JSON-RPC}, \emph{esbuild}, \emph{eslint}, \emph{pre-commit}, \emph{webpack}, \emph{Vite}, \emph{Poetry}, \emph{pydantic}, \emph{jq/yq}}
