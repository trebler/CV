...
\begin{itemize}%
\item Backend: \texttt{C++17/Qt}, \texttt{Go}, \texttt{TypeScript/Node.js (ES2020)}, \texttt{Python}
...
\item Technologies: \texttt{OpenAPI}, \texttt{Redis}, \texttt{RabbitMQ/AMQP}, \texttt{WebSockets}, \texttt{Traefik}, \texttt{Keycloak}
\end{itemize}}
...
\cvitemwithcomment{}{\emph{Bug tracking systems}}{\emph{Jira}, \emph{TFS}, \emph{Redmine}, \emph{GitHub}}
%\cvitemwithcomment{}{\emph{Revision control systems}}{\emph{Git}, \emph{SVN}}
\cvitemwithcomment{}{\emph{Technologies}}{\emph{Redis}, \emph{RabbitMQ}, \emph{AMQP}, \emph{OpenAPI/Swagger}, \emph{NGINX/Traefik/HAproxy}, \emph{WebSockets}, \emph{OAuth 2.0}, \emph{Keycloak}, \emph{WebGL}, \emph{JSON-RPC}}
