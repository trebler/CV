...
\cventry{01/2019--\ldots}{Senior Software Engineer / Tech Lead}{eDrilling}{Stavanger, Norway}{}{Team lead and software architect responsible for transition to cloud and design of modern APIs. Development and deployment of highly available and scalable Kubernetes-native systems based on microservices architecture. Design and implementation of HTTP REST(ful), SSE and WebSocket APIs. Development of reactive web applications\newline{}%
\begin{itemize}%
...
\item DevOps: \texttt{Docker}, \texttt{Kubernetes}, \texttt{Kustomize}, \texttt{Azure}, \texttt{AWS}
\item Technologies: \texttt{Redis}, \texttt{RMQ}, \texttt{MongoDB}, \texttt{WebSockets}, \texttt{OpenAPI}, \texttt{Traefik}, \texttt{Keycloak}, \texttt{Azure AD}
\end{itemize}}
...
\emph{Go}, \emph{C++17}, \emph{Python}, \emph{C99}, \emph{Bash}, \emph{HTML/CSS/SASS}}
...
\cvitemwithcomment{}{\emph{DevOps}}{\emph{Docker}, \emph{Kubernetes}, \emph{AWS}, \emph{Azure}, \emph{DigitalOcean}, \emph{GitHub Actions}, \emph{Ansible}, \emph{Kustomize}}
...
\cvitemwithcomment{}{\emph{Technologies}}{\emph{Redis}, \emph{MongoDB}, \emph{RabbitMQ}, \emph{WebSockets}, \emph{AMQP}, \emph{MQTT}, \emph{SSE}, \emph{OpenAPI/Swagger}, \emph{Traefik/NGINX/HAproxy}, \emph{S3}, \emph{OAuth 2.0}, \emph{Keycloak}, \emph{WebGL}, \emph{JSON-RPC}, \emph{esbuild}, \emph{webpack}, \emph{Vite}, \emph{Poetry}, \emph{pydantic}, \emph{jq/yq}}
