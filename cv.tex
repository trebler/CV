...
\cventry{01/2019\ldots{}}{Full Stack Developer / Cloud Architect}{eDrilling AS}{Stavanger, Norway}{}{Team lead for Product Development. Design and development of (micro-)services, RESTFul and WebSocket APIs, web applications with Kubernetes deployment (cloud/on-premise)\newline{}%
\begin{itemize}%
\item Backend: \texttt{TypeScript/Node.js (ES2020)}, \texttt{Go}, \texttt{Python}, \texttt{C++17/Qt}
...
\cvitemwithcomment{}{\emph{Technologies}}{\emph{Redis}, \emph{RabbitMQ}, \emph{AMQP}, \emph{OpenAPI/Swagger}, \emph{NGINX/Traefik/HAproxy}, \emph{WebSockets}, \emph{OAuth 2.0}, \emph{Keycloak}, \emph{WebGL}, \emph{JSON-RPC}, \emph{esbuild}, \emph{webpack}}
